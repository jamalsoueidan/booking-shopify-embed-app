...
export default forwardRef(
  ({ info, setPrimaryAction }: BookingModalChildProps, ref) => {
      ...
      return (
        <Modal.Section>
          <Text variant="bodyMd" as="p">
            Der er ingen medarbejder længere tilknyttet til dette produkt, gå
            til produkt og tilføj medarbejder.
          </Text>
        </Modal.Section>
      );
    }
        ...
        <Modal.Section>
          <FormLayout>
            ...
            <Text variant="bodyMd" as="p" color="critical">
              ATTENTION: When you update this booking it will not update with
              the order data anymore.
            </Text>
          </FormLayout>
        </Modal.Section>
      </Form>
